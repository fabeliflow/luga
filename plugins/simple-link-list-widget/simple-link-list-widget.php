...
class SimpleLinkListWidget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ($type == "ordered") { echo "<ol ";} else { echo("<ul "); } ?> class="widget__list  widget__list--social">

		<?php foreach ($items as $num => $item) : 
			if (!empty($item)) :
				if (empty($item_links[$num])) :
					echo("<li class='widget__item" . ( !empty( $item_classes[$num] ) ? $item_classes[$num] : '' ) . "'>" . $item . "</li>");
				else :
					if($item_targets[$num]) :
						echo("<li class='widget__item" . ( !empty( $item_classes[$num] ) ? $item_classes[$num] : '' ) . "'><a href='" . $item_links[$num] . "' target='_blank'>" . $item . "</a></li>");
					else :
						echo("<li class='widget__item" . ( !empty( $item_classes[$num] ) ? $item_classes[$num] : '' ) . "'><a href='" . $item_links[$num] . "'>" . $item . "</a></li>");
					endif;
				endif;
			endif;
		endforeach;
		...
		?>
			...
			<div id="<?php echo $this->get_field_id($num); ?>" class="list-item">
				...
				<div class="sllw-edit-item">
					<label for="<?php echo $this->get_field_id('icon'.$num); ?>"><?php echo __("Icon:"); ?></label>
					<select name="<?php echo $this->get_field_name('icon'.$num); ?>" id="<?php echo $this->get_field_id('icon'.$num); ?>" class="widefat">
						<option name="">Select a icon</option>
						<option name="facebook-official" <?php echo ( $icon == 'facebook-official' ? 'selected="selected"' : '' ); ?>>Facebook ( Official )</option>
						<option name="facebook-f" <?php echo ( $icon == 'facebook-f' ? 'selected="selected"' : '' ); ?>>Facebook ( F )</option>
						<option name="facebook-square" <?php echo ( $icon == 'facebook-square' ? 'selected="selected"' : '' ); ?>>Facebook ( Square )</option>
						<option name="twitter" <?php echo ( $icon == 'twitter' ? 'selected="selected"' : '' ); ?>>Twitter</option>
						<option name="twitter-square" <?php echo ( $icon == 'twitter-square' ? 'selected="selected"' : '' ); ?>>Twitter ( Square )</option>
						<option name="google-plus" <?php echo ( $icon == 'google-plus' ? 'selected="selected"' : '' ); ?>>Google Plus</option>
						<option name="google-plus-square" <?php echo ( $icon == 'google-plus-square' ? 'selected="selected"' : '' ); ?>>Google Plus ( Square )</option>
						<option name="google-plus-official" <?php echo ( $icon == 'google-plus-official' ? 'selected="selected"' : '' ); ?>>Google Plus ( Official )</option>
						<option name="linkedin" <?php echo ( $icon == 'linkedin' ? 'selected="selected"' : '' ); ?>>Linked In</option>
						<option name="linkedin-square" <?php echo ( $icon == 'linkedin-square' ? 'selected="selected"' : '' ); ?>>Linked In ( Square )</option>
						<option name="pinterest" <?php echo ( $icon == 'pinterest' ? 'selected="selected"' : '' ); ?>>Pinterest</option>
						<option name="pinterest-p" <?php echo ( $icon == 'pinterest-p' ? 'selected="selected"' : '' ); ?>>Pinterest ( P )</option>
						<option name="pinterest-square" <?php echo ( $icon == 'pinterest-square' ? 'selected="selected"' : '' ); ?>>Pinterest ( Square )</option>
						<option name="envelope" <?php echo ( $icon == 'envelope' ? 'selected="selected"' : '' ); ?>>Envelope</option>
						<option name="envelope-o" <?php echo ( $icon == 'envelope-o' ? 'selected="selected"' : '' ); ?>>Envelope ( Outline )</option>
						<option name="mail-forward" <?php echo ( $icon == 'mail-forward' ? 'selected="selected"' : '' ); ?>>Mail Forward</option>
					</select>
