  ...
  class PD_Masthead {
      ...
      vc_map( array(
        ...
        'params' => array(
          array(
            ...
            'description' => __( 'Type of masthead'),
            'admin_label' => true,
            'value' => array(
              'Select' => '',
              "Video" => "video",
    ...
    public function render_masthead_shortcodes( $atts, $content = null ) {
      ...
      if( $poster_image && $type == 'video' && $video_location == 'youtube' ) {
        $inline_css = 'style="background-image: url(' . wp_get_attachment_url( $poster_image ) . '); background-position: ' . $background_image_location . ';"';
      }

      $ret = '';

      $ret .= '<section class="masthead  masthead--' . $header_type . '">';

        //$ret .= '<iframe width="1728" height="972" src="https://www.youtube.com/embed/s1KguAta69A" frameborder="0" allowfullscreen></iframe>';
        $ret .= '<div class="masthead__container"' . ( $inline_css ? ' ' . $inline_css : '' ) . '>';
        if( !empty( $timestamp ) && $header_type = 'video' ) {
      ...
      if( $header_type == 'video' ) {
        $ret .= '
        <a href="https://www.youtube.com/watch?v=' . $youtube_id . '" class="masthead__play  play  js-play-button">
      ...
      ';
        ...
        $ret .= '<div class="masthead__content">';
